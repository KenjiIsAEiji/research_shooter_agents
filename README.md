...
このGitHubの[Releases](https://github.com/KenjiIsAEiji/research_shooter_agents/releases)にある、Asettsから、「testAppData.zip」からもダウンロードできます。

(Zip状態で約29MB、解凍後は約73.8MBありますのでご注意ください）
